...
app.put("/campus/:id", async function (req, res) {
  try {
    var atualizar = await campus.update(req.body, {
...
app.put("/curso/:id", async function (req, res) {
  try {
    var atualizar = await curso.update(req.body, {
      where: { id: req.params.id },
    });
    res.json(atualizar);
  } catch (error) {
...
app.put("/matricula/:id", async function (req, res) {
  try {
    var atualizar = await matricula.update(req.body, {
      where: { id: req.params.id },
    });
    res.json(atualizar);
  } catch (error) {
...
app.put("/discente/:id", async function (req, res) {
  try {
    var atualizar = await discente.update(req.body, {
      where: { id: req.params.id },
    });
    res.json(atualizar);
  } catch (error) {
...
app.put("/docente/:id", async function (req, res) {
  try {
    var atualizar = await docente.update(req.body, {
      where: { id: req.params.id },
    });
    res.json(atualizar);
  } catch (error) {
...
app.put("/pesquisa/:id", async function (req, res) {
  try {
    var atualizar = await pesquisa.update(req.body, {
      where: { id: req.params.id },
    });
    res.json(atualizar);
